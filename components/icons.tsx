...
export const Icons = {
  ...
  logo: (props: LucideProps) => (
    ...
    >
      <g id="Group-2">
        <g id="Group">
          <path
            d="M512 164C512 73.413 438.587 0 348 0L164 0C73.413 0 0 73.413 0 164L0 348C0 438.587 73.413 512 164 512L348 512C438.587 512 512 438.587 512 348L512 164ZM256.5 53C144.11 53 53 144.11 53 256.5C53 368.89 144.11 460 256.5 460C368.89 460 460 368.89 460 256.5C460 144.11 368.89 53 256.5 53Z"
            id="Vector-Subtract"
            fill="#F3506E"
            fillRule="evenodd"
            stroke="none"
          />
          <path
            d="M256 52C143.334 52 52 143.334 52 256C52 368.666 143.334 460 256 460C368.666 460 460 368.666 460 256C460 143.334 368.666 52 256 52ZM256 88.0885C163.265 88.0885 88.0885 163.265 88.0885 256C88.0885 348.735 163.265 423.912 256 423.912C348.735 423.912 423.912 348.735 423.912 256C423.912 163.265 348.735 88.0885 256 88.0885Z"
            id="Oval-3-Subtract"
            fill="#E98295"
            fillRule="evenodd"
            stroke="none"
          />
          <path
            d="M87 256.5C87 162.888 162.888 87 256.5 87C350.112 87 426 162.888 426 256.5C426 350.112 350.112 426 256.5 426C162.888 426 87 350.112 87 256.5Z"
            id="Oval"
            fill="#FFFFFF"
            fillRule="evenodd"
            stroke="none"
  ...
  MajesticonsMenuAlt(props: SVGProps<SVGSVGElement>) {
    return (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}><g fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M2 8a2 2 0 0 1 2-2h16a2 2 0 1 1 0 4H4a2 2 0 0 1-2-2zm0 8a2 2 0 0 1 2-2h16a2 2 0 1 1 0 4H4a2 2 0 0 1-2-2z" fill="currentColor"/></g></svg>
    )
  }
}
